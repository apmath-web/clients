Feature: Create client integration test
  ...
  Scenario Outline: create client positive
    ...
    Examples:
      | request                                                                                                                                                                                                                                                       |
      | {"birthDate":"2019-01-02","firstName":"TestUser","lastName":"Testerov","passport":{"series":1234,"number":847882},"jobs":[{"name":"test1","wage":72364},{"name":"test4","wage":67628}],"sex":"male","maritalStatus":"married"}                                |
      ...
      | {"firstName":"TestUser","lastName":"Testerov","birthDate":"2007-07-07","passport":{"series":2345,"number":215344},"jobs":null,"sex":"male","maritalStatus":"married","children":2}                                                                              |
